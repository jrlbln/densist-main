					...
					<div className="row">
						<div className="col-lg-8 col-md-12">
							<div className="blog-view">
								<div className="blog blog-single-post call-shadow">
								...
								<div className="card blog-share clearfix call-shadow">
								...
								<div className="card author-widget clearfix call-shadow">
									<div className="card-header">
								...
								<div className="card blog-comments clearfix call-shadow">
									<div className="card-header">
												...
												<div className="comment">
													...
													<div className="comment-block">
														...
														<p>
															...
															vitae, gravida pellentesque urna varius
														...
														<div className="comment">
															...
															<div className="comment-block">
																...
																<p>
																	...
																	gravida pellentesque urna varius
																	vitae.
																</p>
								...
								<div className="card new-comment clearfix call-shadow">
									<div className="card-header">
