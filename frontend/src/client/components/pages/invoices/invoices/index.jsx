...
import { IMG02, IMG03, IMG04, IMG05, IMG06, IMG07, IMG08, IMG09 } from './img';
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 className="table-avatar">
                                                            <Link to="/doctor/transaction" className="avatar avatar-sm me-2">
                                                                <img className="avatar-img rounded-circle" src={IMG02} alt="User" />
                                                            </Link>
                                                            <Link to="/doctor/transaction">David Pope  <span>#PT0016</span></Link>
                                                        </h2>
                                                    </td>
                                                    <td>$450</td>
                                                    <td>14 Nov 2019</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 className="table-avatar">
                                                            ...
                                                            <Link to="/doctor/transaction" >Bernice Hood <span>#PT0001</span></Link>
                                                        </h2>
                                                    </td>
                                                    <td>$200</td>
                                                    <td>13 Nov 2019</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 className="table-avatar">
                                                            ...
                                                            <Link to="/doctor/transaction" >Joshua Miller <span>#PT0002</span></Link>
                                                        </h2>
                                                    </td>
                                                    <td>$100</td>
                                                    <td>12 Nov 2019</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 className="table-avatar">
                                                            ...
                                                            <Link to="/doctor/transaction">Sammy Oneal <span>#PT0003</span></Link>
                                                        </h2>
                                                    </td>
                                                    <td>$350</td>
                                                    <td>11 Nov 2019</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 className="table-avatar">
                                                            ...
                                                            <Link to="/doctor/transaction">Victoria Butler <span>#PT0004</span></Link>
                                                        </h2>
                                                    </td>
                                                    <td>$275</td>
                                                    <td>10 Nov 2019</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 className="table-avatar">
                                                            ...
                                                            <Link  to="/doctor/transaction">Rita McKinney <span>#PT0005</span></Link>
                                                        </h2>
                                                    </td>
                                                    <td>$600</td>
                                                    <td>9 Nov 2019</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 className="table-avatar">
                                                            ...
                                                            <Link  to="/doctor/transaction">Terri Cole <span>#PT0006</span></Link>
                                                        </h2>
                                                    </td>
                                                    <td>$50</td>
                                                    <td>8 Nov 2019</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 className="table-avatar">
                                                            ...
                                                            <Link  to="/doctor/transaction">Melissa Skaggs <span>#PT0007</span></Link>
                                                        </h2>
                                                    </td>
                                                    <td>$400</td>
                                                    <td>7 Nov 2019</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 className="table-avatar">
                                                            ...
                                                            <Link  to="/doctor/transaction">Howard Pena <span>#PT0008</span></Link>
                                                        </h2>
                                                    </td>
                                                    <td>$550</td>
                                                    <td>6 Nov 2019</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 className="table-avatar">
                                                            ...
                                                            <Link  to="/doctor/transaction">Brian Powell <span>#PT0009</span></Link>
                                                        </h2>
                                                    </td>
                                                    <td>$100</td>
                                                    <td>5 Nov 2019</td>
